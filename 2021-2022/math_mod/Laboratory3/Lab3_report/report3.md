...
![Код программы для второй модели](images/img4.jpg){#fig:004 width=80%}

## Построение графиков, моделирование:
![График модели боевых действий между регулярными войсками](images/img1.jpg){#fig:001 width=80%}
